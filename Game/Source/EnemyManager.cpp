...
void EnemyManager::OnStart()
{
    ...
    {
        enemies.insert(enemies.end(), AddEntity("Resources/Sprites/triangle.png", 0.0f + (25.0f * i), 0.0f, 0.0f, 0.1f, 0.1f, true));
        SetEntityColor(enemies[i], SquareCore::RGBA(120, 0, 0, 255));
        SetColliderType(enemies[i], SquareCore::ColliderType::SOLID);
        SetMass(enemies[i], 1000.0f);
